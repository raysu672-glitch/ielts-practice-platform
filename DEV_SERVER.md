...
| 作文批改 FastAPI | 8080 | `cd sources/xiezuopigai/ielts-writing-backend && python -m uvicorn main:app --host 127.0.0.1 --port 8080` | DeepSeek 等配置见该目录 `.env.example`；主站可自动拉起 |
